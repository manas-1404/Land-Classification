...
model_path = r'C:\Users\lyq09mow\Model\Urban_Fabric\86cent7_middle120.keras'

checkpoint_path = r'C:\Users\lyq09mow\Model\Urban_Fabric\86cent7_last25.keras'
...
initial_epoch = 0
try:
    with open(r'C:\Users\lyq09mow\Model\Urban_Fabric\initial_epoch3.txt', 'r') as f:
...
with open(r'C:\Users\lyq09mow\Model\Urban_Fabric\initial_epoch3.txt', 'w') as f:
    f.write(str(epochs - 1))

# Save the entire model for later use
model.save(f'C:\\Users\\lyq09mow\\Model\\Urban_Fabric\\last25_{learning_rate}_bs{batch_size}_ep{epochs}.keras')
