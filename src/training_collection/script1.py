...
model_path = r'C:\Users\lyq09mow\Model\Urban_Fabric\86cent7.keras'

checkpoint_path = r'C:\Users\lyq09mow\Model\Urban_Fabric\86cent7_initial30.keras'
...
reduce_lr = ReduceLROnPlateau(monitor='val_loss', factor=0.5, patience=5, min_lr=0.000000001, verbose=1)
tqdm_callback = TqdmCallback(verbose=1)

# Determine the initial epoch
initial_epoch = 0
try:
    with open(r'C:\Users\lyq09mow\Model\Urban_Fabric\initial_epoch1.txt', 'r') as f:
...
with open(r'C:\Users\lyq09mow\Model\Urban_Fabric\initial_epoch1.txt', 'w') as f:
    f.write(str(epochs - 1))

# Save the entire model for later use
model.save(f'C:\\Users\\lyq09mow\\Model\\Urban_Fabric\\initial30_{learning_rate}_bs{batch_size}_ep{epochs}.keras')
